...
import { PortfolioProjectsSectionComponent } from './projects-section/portfolio-projects-section';
import { PortfolioContactSectionComponent } from './contact-section/portfolio-contact-section';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, PortfolioProjectsSectionComponent, PortfolioContactSectionComponent],
